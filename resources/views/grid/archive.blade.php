...
@section('content')
	...
	@php
		...
		$archiveGridData = [
			'dataProvider' 			=> $archiveGridDataProvider,
			'title' 				=> 'Ваши заархивированные сетки',
			'useFilters' 			=> false,
			...
			'actionTypes' => [ // Required
				[
					...
					'htmlAttributes' => [ // Optional
						...
						'onclick' => 'return window.confirm("Вы действительно хотите удалить эту сетку?");'
					]
				],
				[
